import type { Point, BoundingBox, ElementType } from '@/core/type';
import type { FlexTree } from '@/core/math/flex-tree';
...
export abstract class AbstractGraphicElement extends ReactiveNode {
  ...
  public onGeometryChanged: ((el: AbstractGraphicElement) => void) | null =
    null;
