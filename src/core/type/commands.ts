...
export interface CreateCommand {
  type: 'CREATE';
  options: {
    element: import('@/core/shapes/elements/AbstractGraphicElement').AbstractGraphicElement;
  };
}
...
export interface CreateFileCommand {
  type: 'CREATE_FILE';
  options: {
    elements: import('@/core/shapes/elements/AbstractGraphicElement').AbstractGraphicElement[];
    groupId: string;
    groupName: string;
  };
}
...
export interface DragHandlerContext {
  getElements: () => import('@/core/shapes/elements/AbstractGraphicElement').AbstractGraphicElement[];
