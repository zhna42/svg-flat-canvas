...
import type { BooleanOp, Pt } from '@/core/type';
import { booleanOperation } from '@/core/math/boolean/BooleanKernel';
import { dString } from '@/core/math/boolean/BooleanEngine';
import { PreviewElement } from '@/core/shapes/elements/PreviewElement';
import type { EventBus } from '@/core/event-bus/EventBus';
import type { CommandBus } from '@/core/commands/CommandBus';
import { MM_TO_PX } from '@/constants';
import { polyIntersectsPoly } from '@/core/hit-test';
...
export class BooleanHandler {
  ...
  private updateResultPreview(): void {
    ...
    const commands: import('@/core/type').PathCommand[] = [];
